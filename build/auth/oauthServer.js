...
export function getStoredUserToken(sessionId) {
    if (!sessionId)
        return undefined;
...
export function storeUserToken(sessionId, token, expiresIn) {
    const expiresAt = expiresIn ? Date.now() + expiresIn * 1000 : undefined;
    userTokens.set(sessionId, { token, expiresAt });
}
export async function handleOAuthAuthorize(req, res, searchParams) {
...
export async function handleOAuthCallback(req, res, body) {
    // Parse form data
